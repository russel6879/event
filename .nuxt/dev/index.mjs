...
import { renderSSRHead } from 'file://D:/quiknew/node_modules/@unhead/ssr/dist/index.mjs';
...
import { version, unref } from 'file://D:/quiknew/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://D:/quiknew/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://D:/quiknew/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"D:/quiknew/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\quiknew","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\quiknew\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\quiknew\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\quiknew\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:\\quiknew\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _KYk1SOLZx6 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "D:/quiknew";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _Ele7XerBSK = (nitroApp) => {
...
const getClientManifest = () => import('file://D:/quiknew/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://D:/quiknew/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
